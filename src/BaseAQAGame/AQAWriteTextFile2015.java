 ...
 * 1. no parameters - creates an instance of BaseAQAGame.AQAWriteTextFile2015
 *
 ...
 *
 */
public class AQAWriteTextFile2015 {
   ...
   */
  AQAWriteTextFile2015() {
  } // end constructor BaseAQAGame.AQAWriteTextFile2015

  /**
   * Constructor - filename is opened to write at the start of the file
   * @param filename  name of file to be opened
   */
  AQAWriteTextFile2015(String filename) {
   ...
   */
  AQAWriteTextFile2015(String filename, boolean append) {
...
} // end BaseAQAGame.AQAWriteTextFile2015